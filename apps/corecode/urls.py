...
urlpatterns = [
    ...
    path("doccategory/list/", PermitDocCategoryListView.as_view(), name="doccategory"),
    path("doccategory/create/", PermitDocCategoryCreateView.as_view(), name="doccategory-create"),
    path("doccategory/<int:pk>/update/", PermitDocCategoryUpdateView.as_view(), name="doccategory-update"),
    path("doccategory/<int:pk>/delete/", PermitDocCategoryDeleteView.as_view(), name="doccategory-delete"),
