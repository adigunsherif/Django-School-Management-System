...
@receiver(post_save, sender=EmployeeBulkUpload)
def create_bulk_employee(sender, created, instance, *args, **kwargs):
    if created:
...
@receiver(post_delete, sender=EmployeeBulkUpload)
